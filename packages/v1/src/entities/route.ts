import { ChainId, Currency, Token, WAVAX } from '@sectorone/sdk-core'
  ...
  public constructor(pairs: Pair[], input: Currency, output?: Currency) {
    ...
    invariant(
      typeof output === 'undefined' ||
        ...
        (output.isNative &&
          pairs[pairs.length - 1].involvesToken(WAVAX[pairs[0].chainId])),
      'OUTPUT'
    )

    const path: Token[] = [
      input instanceof Token ? input : WAVAX[pairs[0].chainId]
    ]
